 ...
 <v-carousel hide-controls>
        <v-carousel-item src="">
          <v-container fluid grid-list-lg>
            <v-layout row align-center px-5>
              <v-flex xs3 lg2>
                <v-avatar size="100%"><img src="/img/juanjose.jpg" /></v-avatar>
              </v-flex>
              <v-flex xs9 lg10>
        ...
        <v-carousel-item src="">
          <v-container fluid grid-list-lg>
            <v-layout row align-center px-5>
              <v-flex xs3 lg2>
                <v-avatar size="100%"><img src="/img/torrenegra.jpg" /></v-avatar>
              </v-flex>
              <v-flex xs9 lg10>
                <div class="subheading">
        ...
        <v-carousel-item src="">
          <v-container fluid grid-list-lg>
            <v-layout row align-center px-5>
              <v-flex xs3 lg2>
                <v-avatar size="100%"><img src="/img/helena.jpg" /></v-avatar>
              </v-flex>
              <v-flex xs9 lg10>
                <div class="subheading">
        ...
        <v-expansion-panel-content ripple>
          ...
          <v-card>
            <v-card-text class="grey lighten-4">
              ...
              <p name="30c1" id="30c1" class="graf graf--p graf-after--p">We are currently building an open source platform called <a href="https://neocratium.org" target="_blank">Neocratium</a>, and we encourage others to build alternatives. (We'll gladly advise.) <a href="https://neocratium.org" target="_blank">Neocratium</a> will allow communities of any size and type — even non-political ones — to manage their democracies. Once <a href="https://neocratium.org" target="_blank">Neocratium</a> is ready, groups can create communities using the hosted version, or download the source code and install their own on a server.</p>
              <p name="ae80" id="ae80" class="graf graf--p graf-after--p">When a community uses <a href="https://neocratium.org" target="_blank">Neocratium</a>, the settings of the platform will be managed by a team of administrators. The platform administrators will be appointed by the executive branch of the government of each community (following procedures similar to current democratic convention). Each citizen will have an account provided and/or approved by the administrators. <a href="https://neocratium.org" target="_blank">Neocratium</a> will offer single sign-on integration with existing electronic IDs already offered by numerous governments.</p>
              <p name="eac4" id="eac4" class="graf graf--p graf-after--p">Neocratia will be working with electoral management bodies (EMBs) and other NGOs to guarantee that <a href="https://neocratium.org" target="_blank">Neocratium</a> and the other electronic platforms work towards preventing, recording, and reporting potential electoral fraud.</p>
              <p name="c7ce" id="c7ce" class="graf graf--p graf-after--p">If you are interested in helping to create <a href="https://neocratium.org" target="_blank">Neocratium</a> as a volunteer, please contact neocratium@neocratia.org.</p>
          ...
          <v-card>
            <v-card-text class="grey lighten-4">
              ...
              <ol class="postList">
                  ...
                  <li name="a2c7" id="a2c7" class="graf graf--li graf-after--li">Once elected, Neocratia representatives pass the laws needed to upgrade the legislative body with a technology platform (<a href="https://neocratium.org" target="_blank">Neocratium</a> or an alternative one).</li>
              </ol>
              ...
              <p name="21c9" id="21c9" class="graf graf--p graf-after--p">Proxy representatives act as intermediaries between the group who elected them and the public office they are elected to. Their actions are circumscribed by the decisions of the group using <a href="https://neocratium.org" target="_blank">Neocratium</a>.</p>
      ...
      <v-container fluid grid-list-lg>
        <v-layout column align-center justify-center>
          ...
          <div class="mb-4 spread-the-word">
            ...
            <a href="https://api.whatsapp.com/send?text=Let’s upgrade the way our laws are created https%3A//www.neocratia.org/" data-action="share/whatsapp/share" class="button" target="_blank">
              <v-btn light class="square">
                <v-icon x-large primary>mdi-whatsapp</v-icon>
              </v-btn>
            </a>
            <a href="https://twitter.com/home?status=Let’s upgrade the way our laws are created https%3A//www.neocratia.org/" class="button" target="_blank">
              <v-btn light class="square">
