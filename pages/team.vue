  ...
  <v-flex xs12 sm10 md8 lg6 elevation-1 content-area>
    <v-card class="py-3 px-3">
      ...
      <v-layout row wrap>
            ...
            <v-card class=" darken-2 ">
              <v-container fluid grid-list-md>
                <v-layout row>
                  <v-flex xs12>
                    <div>
                      <div class="headline">Alexander Torrenegra</div>
                      <div>Alexander Torrenegra is a Colombian-American entrepreneur. He founded multiple companies including Zapata Torrenegra Labs, Voice123, VoiceBunny and Torre. He was featured in MIT’s TR35 Colombia’s list of Top Innovators Under 35 in 2012. In 2013, he was part of a delegation of immigrant-entrepreneurs that met with President Barack Obama to push for immigration reform. He also works to improve government support for innovation in Colombia and is the founder of Neocratia.</div>
                    </div>
                  </v-flex>
                  <v-flex xs12>
                    <v-card-media
          ...
          <v-flex xs12>
            <v-card class=" darken-2 mt-4">
              <v-container fluid grid-list-md>
                <v-layout row>
                  <v-flex xs12>
                    <v-card-media
                      src="/img/team/andres.jpg"
                      height="320px"
                      contain
                    ></v-card-media>
                  </v-flex>
                  <v-flex xs12>
                    <div>
                      <div class="headline">Andrés González</div>
                      <div>Andres is a software developer, entrepreneur and tech enthusiast. He has been involved in the implementation of several software products during more than 10 years. He joined Neocratia as a volunteer in 2015 after a hackathon in Bogotá. Since then he has been involved in the product development and now he is the maintainer of the Neocratium platform.</div>
                    </div>
                  </v-flex>
            ...
            <v-card class=" darken-2 mt-4">
              <v-container fluid grid-list-md>
                <v-layout row>
                  <v-flex xs12>
                    <div>
                      <div class="headline">Helena Schwertheim</div>
                      <div>Helena is passionate about innovating for a more accountable democracy. Originally from New Zealand, she has a background in political studies, sociology and international relations, having lived and studied in Australia, Colombia, Spain and France, and is now based in Sweden. During the day Helena is a researcher, analysing democratic trends. By night she works with Neocrats to upgrade how laws are made.</div>
                    </div>
                  </v-flex>
                  <v-flex xs12>
                    <v-card-media
                      src="/img/team/helena.jpg"
                      height="320px"
                      contain
                    ></v-card-media>
                  </v-flex>
